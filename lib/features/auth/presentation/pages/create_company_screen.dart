                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                                  ...
                                  return Stack(
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: Image.file(companyImages[index]),
                                      ),
                                      GestureDetector(
                                        onTap: () {
                                          setState(() {
                                        ...
                                        child: Align(
                                          ...
                                          child: Container(
                                            ...
                                            child: const Icon(Icons.delete, color: ColorStyles.baseLightBlue, size: 18,),
                                          ),
                                        ),
                                      )
                                    ],
                      ...
                      if (companyImages.isEmpty) Image.asset(Images.emptyImage)
                    ],
                  ),
                ),
              ],
